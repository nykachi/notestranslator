...
const Notes = ({ route, navigation, ...props }) => {
  ...
  function deleteNote(index) {
    ...
    let movedNote = newArray.splice(index, 1)[0];
    props.setNotes(newArray);
    props.setMoveToBin(movedNote);
    // console.log({ movedNote, moveToBin: props.moveToBin });//
    let bin = [movedNote, ...props.moveToBin];
    //console.log({ notes: props.notes, bin }); //
    ...
    <View style={[styles.notesContainer]}>
      ...
      <View style={styles.searchContainer}>
        ...
        <TouchableOpacity
          ...
          disabled={props.notes.length === 0 ? true : false}
        >
          ...
          props.notes.map((item, index) => (
            ...
            <View style={styles.item} key={index}>
              ...
              <View style={styles.dateContainer}>
                <Text onSubmit={handleUpdate}>
                  {item.isUpdated
                    ? `Updated At ${formatDate(item.dateTime)}`
                    : `Created At ${formatDate(item.dateTime)}`}
                </Text>
                ...
                <TouchableOpacity
                  onPress={() =>
                    navigation.navigate('EditNote', { i: index, n: item })
                  }
                >
